            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">[GCC] - Notificação</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                         <table class="body-text">
                          <tr>
                              <td class="body-text-cell" width="600">
                                  <p>Informamos que o contrato nº <strong><?php echo htmlspecialchars( $numerodoContrato, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>, referente a Consultor(a)<strong> <?php echo htmlspecialchars( $nomeRazao, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> chegou à
                                    80% de utilização dos recursos disponíveis e necessita de verificação sobre a necessidade de 
                                    novo aporte financeiro. </p>
                            </td>
                          </tr>
                        </table>
                         <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                                <p>Att.</p>
                                <p>Gerencia de Compras e Contratos – CONASS</p>
                            </td>
                          </tr>
                        </table>
                      </td>
